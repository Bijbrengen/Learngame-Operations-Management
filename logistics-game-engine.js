(() => {
  ...
  const PART_DEFINITIONS = Object.freeze({
    ...
    yellow_8: { id: "yellow_8", label: "Steen geel", color: "yellow", size: "2×4", width: 2, depth: 4, blokId: "element.brick.2x4.yellow", blokFile: "elements/element_blok_2x4_geel.blok" },
    ...
    blue_8: { id: "blue_8", label: "Steen blauw", color: "blue", size: "2×4", width: 2, depth: 4, blokId: "element.brick.2x4.blue", blokFile: "elements/element_blok_2x4_blauw.blok" },
    ...
    red_8: { id: "red_8", label: "Steen rood", color: "red", size: "2×4", width: 2, depth: 4, blokId: "element.brick.2x4", blokFile: "elements/element_blok_2x4.blok" },
    ...
    white_8: { id: "white_8", label: "Steen wit", color: "white", size: "2×4", width: 2, depth: 4, blokId: "element.brick.2x4.white", blokFile: "elements/element_blok_2x4_wit.blok" },
